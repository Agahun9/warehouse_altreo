          ...
          <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
            <div>
              <div class="d-flex flex-wrap gap-2 mb-3">
                ...
                <span class="badge rounded-pill px-3 py-2"><i class="bi bi-pencil-square me-1"></i><?php if ((true && (true && null !== ($_smarty_tpl->getValue('product')['id'] ?? null)))) {?>Edycja<?php } else { ?>Nowy rekord<?php }?></span>
              </div>
              <h3 class="h4 mb-2"><?php if ((($tmp = $_smarty_tpl->getValue('product')['product_name'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp)) {
echo htmlspecialchars((string)$_smarty_tpl->getValue('product')['product_name'], ENT_QUOTES, 'UTF-8', true);
} else { ?>Uzupelnij dane produktu<?php }?></h3>
            ...
            <div class="text-end">
              ...
              <div class="fs-5 fw-semibold" id="heroSku"><?php if ((($tmp = $_smarty_tpl->getValue('product')['sku'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp)) {
echo htmlspecialchars((string)$_smarty_tpl->getValue('product')['sku'], ENT_QUOTES, 'UTF-8', true);
} else { ?>wygeneruje sie automatycznie<?php }?></div>
            </div>
          </div>
        </div>
...
" id="product-form">
          <input type="hidden" name="return_url" value="<?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('returnUrl') ?? null)===null||$tmp==='' ? './index.php?controller=products&action=index' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
">
        
          <?php if ((true && (true && null !== ($_smarty_tpl->getValue('product')['id'] ?? null)))) {?>
                ...
                <div class="product-tab-panel active" data-product-tab-panel="overview">
                  ...
                  <div class="product-mini-stat">
                    <div class="product-mini-stat-card">
                      <span>SKU</span>
                      <strong id="overviewSku"><?php if ((($tmp = $_smarty_tpl->getValue('product')['sku'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp)) {
echo htmlspecialchars((string)$_smarty_tpl->getValue('product')['sku'], ENT_QUOTES, 'UTF-8', true);
} else { ?>Automatyczne<?php }?></strong>
                    </div>
                    <div class="product-mini-stat-card">
                      <span>Stan</span>
                      <strong id="overviewQuantity"><?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('product')['quantity'] ?? null)===null||$tmp==='' ? 0 ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
</strong>
                    </div>
                    <div class="product-mini-stat-card">
                      <span>Cena brutto</span>
                      <strong id="overviewPrice"><?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('product')['price_gross'] ?? null)===null||$tmp==='' ? '0.00' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
</strong>
                    </div>
                  </div>
                    ...
                    <div class="product-section-box accent">
                      ...
                      <div class="row g-3">
                        <div class="col-md-4">
                          ...
                          <input type="text" class="form-control" id="sku" name="sku" value="<?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('product')['sku'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
" readonly>
...
" required>
                        ...
                        <div class="col-12">
                          ...
                          <textarea class="form-control" id="description" name="description" rows="4" placeholder="Krotki opis produktu"><?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('product')['description'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
</textarea>
                        </div>
                        <div class="col-md-5">
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
                        ...
                        <div class="col-md-3">
                          ...
                          <input type="text" class="form-control" id="localization" name="localization" value="<?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('product')['localization'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
">
                        </div>
                        <div class="col-12">
                          <label for="img" class="form-label">Galeria grafik</label>
                          <input type="hidden" class="form-control" id="img" name="img" value="<?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('product')['img'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
">
                    ...
                    <div class="product-section-box">
                      ...
                      <div class="row g-3">
                        <div class="col-md-3">
                          ...
                          <input type="number" min="0" class="form-control" id="quantity" name="quantity" value="<?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('product')['quantity'] ?? null)===null||$tmp==='' ? 0 ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
">
                        </div>
                        <div class="col-md-3">
                          <label for="dimensions" class="form-label">Wymiary</label>
                          <input type="text" class="form-control" id="dimensions" name="dimensions" value="<?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('product')['dimensions'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
" placeholder="np. 120x80">
                        </div>
                        <div class="col-md-6">
                          <label for="contoursSearch" class="form-label">Obrys</label>
                          <input type="hidden" id="contours" name="contours" value="<?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('product')['contours'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
">
                          <input type="text" class="form-control mb-2" id="contoursSearch" value="<?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('product')['contours'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
" placeholder="Wyszukaj folder z OBRYSY_GENERATOR">
                          <div class="contour-picker-results" id="contourPickerResults">
                            <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('contourDirectories'), 'contourDirectory');
$foreach1DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('contourDirectory')->value) {
$foreach1DoElse = false;
?>
                              <button type="button" class="contour-picker-option<?php if ((($tmp = $_smarty_tpl->getValue('product')['contours'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp) == $_smarty_tpl->getValue('contourDirectory')) {?> active<?php }?>" data-contour-option="<?php echo htmlspecialchars((string)$_smarty_tpl->getValue('contourDirectory'), ENT_QUOTES, 'UTF-8', true);?>
"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('contourDirectory'), ENT_QUOTES, 'UTF-8', true);?>
</button>
                            <?php
}
if ($foreach1DoElse) {
                    ...
                    <div class="product-section-box soft">
                      ...
                      <div class="row g-3">
                        <div class="col-md-4">
                          ...
                          <input type="number" step="0.01" min="0" class="form-control" id="vat_rate" name="vat_rate" value="<?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('product')['vat_rate'] ?? null)===null||$tmp==='' ? '23.00' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
">
                        </div>
                        <div class="col-md-4">
                          <label for="price_net" class="form-label">Cena netto</label>
                          <input type="number" step="0.01" min="0" class="form-control" id="price_net" name="price_net" value="<?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('product')['price_net'] ?? null)===null||$tmp==='' ? '0.00' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
">
                        </div>
                        <div class="col-md-4">
                          <label for="price_gross" class="form-label">Cena brutto</label>
                          <input type="number" step="0.01" min="0" class="form-control" id="price_gross" name="price_gross" value="<?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('product')['price_gross'] ?? null)===null||$tmp==='' ? '0.00' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
">
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="product-tab-stack">
                    <div class="product-section-box soft">
                      ...
                      <div id="related-products-container" class="row g-3">
                        <?php if ($_smarty_tpl->getValue('relatedProducts')) {?>
                          <?php
...
?>
                            <div class="col-md-6 related-product-card" data-product-id="<?php echo $_smarty_tpl->getValue('relatedProduct')['id'];?>
">
                              <div class="border rounded p-3 h-100 bg-light-subtle">
                                <div class="d-flex justify-content-between align-items-start gap-2 mb-2">
                                  <div>
                                    <div class="fw-semibold"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('relatedProduct')['product_name'], ENT_QUOTES, 'UTF-8', true);?>
</div>
                                    <div class="small text-secondary">#<?php echo $_smarty_tpl->getValue('relatedProduct')['id'];?>
 | <?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('relatedProduct')['sku'] ?? null)===null||$tmp==='' ? '-' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
</div>
                                  </div>
                                  <button type="button" class="btn btn-sm btn-outline-danger remove-related-product">Usun</button>
                                </div>
                                <input type="hidden" name="related_product_ids[]" value="<?php echo $_smarty_tpl->getValue('relatedProduct')['id'];?>
">
                                <?php if ((($tmp = $_smarty_tpl->getValue('relatedProduct')['category_name'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp)) {?>
                                  <div class="small text-secondary">Kategoria: <?php echo htmlspecialchars((string)$_smarty_tpl->getValue('relatedProduct')['category_name'], ENT_QUOTES, 'UTF-8', true);?>
</div>
                                <?php }?>
                              </div>
                            </div>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
                    ...
                    <div class="product-section-box soft">
                      ...
                      <div id="derived-products-container" class="row g-3">
                        <?php if ($_smarty_tpl->getValue('derivedStockSources')) {?>
                          <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('derivedStockSources'), 'derivedProduct');
$foreach3DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('derivedProduct')->value) {
$foreach3DoElse = false;
?>
                            <div class="col-md-6 derived-product-card" data-product-id="<?php echo $_smarty_tpl->getValue('derivedProduct')['id'];?>
">
                              <div class="border rounded p-3 h-100 bg-light-subtle">
                                <div class="d-flex justify-content-between align-items-start gap-2 mb-2">
                                  <div>
                                    <div class="fw-semibold"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('derivedProduct')['product_name'], ENT_QUOTES, 'UTF-8', true);?>
</div>
                                    <div class="small text-secondary">#<?php echo $_smarty_tpl->getValue('derivedProduct')['id'];?>
 | <?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('derivedProduct')['sku'] ?? null)===null||$tmp==='' ? '-' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
</div>
                                  </div>
                                  <button type="button" class="btn btn-sm btn-outline-danger remove-derived-product">Usun</button>
                                </div>
                                <input type="hidden" name="derived_source_product_ids[]" value="<?php echo $_smarty_tpl->getValue('derivedProduct')['id'];?>
">
                                <?php if ((($tmp = $_smarty_tpl->getValue('derivedProduct')['category_name'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp)) {?>
                                  <div class="small text-secondary">Kategoria: <?php echo htmlspecialchars((string)$_smarty_tpl->getValue('derivedProduct')['category_name'], ENT_QUOTES, 'UTF-8', true);?>
</div>
                                <?php }?>
                              </div>
                            </div>
                    ...
                    <div class="row g-2 align-items-end">
                      <div class="col-md-8">
                        ...
                        <select id="existingCustomFieldSelect" class="form-select form-select-sm">
                          ...
                          <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('customFieldDefinitions'), 'customFieldDefinition');
$foreach4DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('customFieldDefinition')->value) {
$foreach4DoElse = false;
?>
                            <option value="<?php echo htmlspecialchars((string)$_smarty_tpl->getValue('customFieldDefinition')['id'], ENT_QUOTES, 'UTF-8', true);?>
" data-name="<?php echo htmlspecialchars((string)$_smarty_tpl->getValue('customFieldDefinition')['name'], ENT_QUOTES, 'UTF-8', true);?>
"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('customFieldDefinition')['name'], ENT_QUOTES, 'UTF-8', true);?>
</option>
                          <?php
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
                  ...
                  <div id="assignedCustomFieldsContainer" class="row g-3">
                    <?php if ($_smarty_tpl->getValue('assignedCustomFields')) {?>
                      <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('assignedCustomFields'), 'assignedCustomField');
$foreach5DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('assignedCustomField')->value) {
$foreach5DoElse = false;
?>
                        <div class="col-md-6 assigned-custom-field-card" data-definition-id="<?php echo $_smarty_tpl->getValue('assignedCustomField')['id'];?>
">
                          <div class="border rounded p-3 h-100 bg-light-subtle">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                              <label class="form-label mb-0" for="custom_field_<?php echo $_smarty_tpl->getValue('assignedCustomField')['id'];?>
"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('assignedCustomField')['name'], ENT_QUOTES, 'UTF-8', true);?>
</label>
                            ...
                            <input
                              type="text"
                              class="form-control"
                              id="custom_field_<?php echo $_smarty_tpl->getValue('assignedCustomField')['id'];?>
"
                              name="custom_field_values[<?php echo $_smarty_tpl->getValue('assignedCustomField')['id'];?>
]"
                              value="<?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('assignedCustomField')['value'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
"
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
                  ...
                  <?php if ($_smarty_tpl->getValue('customFieldDefinitions')) {?>
...
echo htmlspecialchars((string)$_smarty_tpl->getValue('product')['product_name'], ENT_QUOTES, 'UTF-8', true);
                  ...
                  <div class="product-summary-row"><span class="text-secondary">Kategoria</span><strong id="summaryCategory"><?php if ((($tmp = $_smarty_tpl->getValue('product')['category_id'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp)) {
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('categories'), 'category');
$foreach7DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('category')->value) {
$foreach7DoElse = false;
if ($_smarty_tpl->getValue('product')['category_id'] == $_smarty_tpl->getValue('category')['id']) {
echo htmlspecialchars((string)$_smarty_tpl->getValue('category')['name'], ENT_QUOTES, 'UTF-8', true);
}
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);
} else { ?>-<?php }?></strong></div>
                  <div class="product-summary-row"><span class="text-secondary">Stan</span><strong id="summaryQuantity"><?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('product')['quantity'] ?? null)===null||$tmp==='' ? 0 ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
</strong></div>
...
" class="btn btn-outline-secondary"><i class="bi bi-arrow-left me-2"></i>Wroc do listy</a>
                ...
                <?php if ((true && (true && null !== ($_smarty_tpl->getValue('product')['id'] ?? null)))) {?>
                  <div class="product-summary-box mt-3">
                    ...
                    <?php if ($_smarty_tpl->getValue('productHistory')) {?>
                      <div class="d-grid gap-3">
                        <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('productHistory'), 'historyEntry');
$foreach8DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('historyEntry')->value) {
$foreach8DoElse = false;
?>
                          <div class="border rounded-4 p-3 bg-white">
                            <div class="d-flex justify-content-between gap-2 flex-wrap mb-2">
                              <span class="badge text-bg-light border"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('historyEntry')['action_label'], ENT_QUOTES, 'UTF-8', true);?>
</span>
                              <span class="small text-secondary"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('historyEntry')['created_at'], ENT_QUOTES, 'UTF-8', true);?>
</span>
                            </div>
                            <div class="small fw-semibold mb-1"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('historyEntry')['actor_display'], ENT_QUOTES, 'UTF-8', true);?>
</div>
                            <div class="small text-secondary mb-2"><?php echo htmlspecialchars((string)(($tmp = $_smarty_tpl->getValue('historyEntry')['summary'] ?? null)===null||$tmp==='' ? 'Zapisano zmiany.' ?? null : $tmp), ENT_QUOTES, 'UTF-8', true);?>
</div>
                            <?php if ($_smarty_tpl->getValue('historyEntry')['changes']) {?>
                              <div class="small">
                                <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('historyEntry')['changes'], 'change');
$foreach9DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('change')->value) {
$foreach9DoElse = false;
?>
                                  <div class="mb-1"><strong><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('change')['label'], ENT_QUOTES, 'UTF-8', true);?>
:</strong> <?php echo htmlspecialchars((string)$_smarty_tpl->getValue('change')['before'], ENT_QUOTES, 'UTF-8', true);?>
 <span class="text-secondary">-></span> <?php echo htmlspecialchars((string)$_smarty_tpl->getValue('change')['after'], ENT_QUOTES, 'UTF-8', true);?>
</div>
                                <?php
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
...
>
  (function () {
    ...
    var hasAssignedSku = <?php if ((true && (true && null !== ($_smarty_tpl->getValue('product')['id'] ?? null))) && (($tmp = $_smarty_tpl->getValue('product')['sku'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp) != '') {?>true<?php } else { ?>false<?php }?>;
    var productId = '<?php if ((true && (true && null !== ($_smarty_tpl->getValue('product')['id'] ?? null)))) {
echo $_smarty_tpl->getValue('product')['id'];
}?>';
...
;
    ...
    function refreshSku() {
      ...
      var url = '<?php echo strtr((string)$_smarty_tpl->getValue('baseUrl'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
						"\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
						"`" => "\\`", "\${" => "\\\$\{"));?>
?controller=products&action=nextsku&category_id=' + encodeURIComponent(categoryId);
...
?controller=products&action=empikparameteroptions&category_id=' + encodeURIComponent(categoryId) + '&attribute_id=' + encodeURIComponent(attributeId) + '&q=' + encodeURIComponent(phrase) + '&limit=25';
    ...
    function searchCopyProducts() {
      ...
      var url = '<?php echo strtr((string)$_smarty_tpl->getValue('baseUrl'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
						"\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
						"`" => "\\`", "\${" => "\\\$\{"));?>
?controller=products&action=copyproducts&exclude_id=' + encodeURIComponent(productId || '0') + '&search=' + encodeURIComponent(term);
      fetch(url, { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
        .then(function (response) {
          return response.text().then(function (rawText) {
            var parsed = {};
    ...
    function searchRelatedProducts() {
      ...
      var query = '<?php echo strtr((string)$_smarty_tpl->getValue('baseUrl'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
						"\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
						"`" => "\\`", "\${" => "\\\$\{"));?>
?controller=products&action=relatedproducts&exclude_id=' + encodeURIComponent(productId || '0') + '&search=' + encodeURIComponent(term);
    ...
    function searchDerivedProducts() {
      ...
      var query = '<?php echo strtr((string)$_smarty_tpl->getValue('baseUrl'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
						"\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
						"`" => "\\`", "\${" => "\\\$\{"));?>
?controller=products&action=derivedproducts&exclude_id=' + encodeURIComponent(productId || '0') + '&search=' + encodeURIComponent(term);
      for (var i = 0; i < ids.length; i++) {
        query += '&exclude_ids[]=' + encodeURIComponent(ids[i]);
      }
    ...
    function copyParametersFromSelectedProduct() {
      ...
      var url = '<?php echo strtr((string)$_smarty_tpl->getValue('baseUrl'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
						"\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
						"`" => "\\`", "\${" => "\\\$\{"));?>
?controller=products&action=copiedparameters&source_id=' + encodeURIComponent(sourceId);
    ...
    function loadAllegroParameters() {
      ...
      var url = '<?php echo strtr((string)$_smarty_tpl->getValue('baseUrl'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
						"\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
						"`" => "\\`", "\${" => "\\\$\{"));?>
?controller=products&action=allegroparameters&category_id=' + encodeURIComponent(categoryId) + '&include_values=1';
      if (productId) {
...
?controller=products&action=empikparameters&category_id=' + encodeURIComponent(categoryId) + '&include_values=1';
    ...
    if (deleteCustomFieldDefinitionBtn && deleteCustomFieldDefinitionSelect) {
      deleteCustomFieldDefinitionBtn.addEventListener('click', function () {
        ...
        form.method = 'post';
        form.action = '<?php echo strtr((string)$_smarty_tpl->getValue('baseUrl'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
						"\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
						"`" => "\\`", "\${" => "\\\$\{"));?>
?controller=products&action=deletecustomfielddefinition';
    ...
    var contourDirectoryItems = <?php echo (($tmp = $_smarty_tpl->getValue('contourDirectoriesJson') ?? null)===null||$tmp==='' ? '[]' ?? null : $tmp);?>
;
    ...
    function uploadGalleryFiles(files) {
      ...
      fetch('<?php echo strtr((string)$_smarty_tpl->getValue('productImagesUploadUrl'), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
						"\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
						"`" => "\\`", "\${" => "\\\$\{"));?>
', {
        method: 'POST',
    ...
    try {
      var initialGalleryItems = <?php echo (($tmp = $_smarty_tpl->getValue('productImagesJson') ?? null)===null||$tmp==='' ? '[]' ?? null : $tmp);?>
;
