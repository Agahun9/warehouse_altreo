      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-end">
            ...
            <li class="breadcrumb-item"><a href="{$baseUrl}?controller=mediamarkt&action=index">MediaMarkt</a></li>
    ...
    <div class="container-fluid">
      <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
          ...
          <a href="{$baseUrl}?controller=mediamarkt&action=index" class="btn btn-sm btn-outline-secondary">Wroc do listy</a>
        </div>
        <div class="card-body">
          <div class="row g-3">
