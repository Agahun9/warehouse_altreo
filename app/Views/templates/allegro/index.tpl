        ...
        <div class="card-body border-bottom">
          <form method="get" action="{$baseUrl}" class="row g-2">
            ...
            <div class="col-xl-2 col-md-4">
              ...
              <input type="text" name="warehouse_quantity" value="{$filters.warehouse_quantity|escape}" class="form-control" placeholder="np. 0-5">
              <div class="form-text">Negacja: <code>-0-5</code>, <code>!0</code>.</div>
            </div>
            <div class="col-xl-2 col-md-4">
              <label class="form-label">Stan Allegro</label>
              <input type="text" name="allegro_quantity" value="{$filters.allegro_quantity|escape}" class="form-control" placeholder="np. 0-5">
            </div>
            <div class="col-xl-2 col-md-4">
          ...
          <div class="allegro-pagination-panel">
            ...
            <div class="allegro-pagination-bar">
              ...
              <form method="get" action="{$baseUrl}" class="d-flex gap-2 align-items-center">
                ...
                <input type="hidden" name="warehouse_quantity" value="{$filters.warehouse_quantity|escape}">
                <input type="hidden" name="allegro_quantity" value="{$filters.allegro_quantity|escape}">
                <input type="hidden" name="queue_status" value="{$queueStatusFilter|escape}">
