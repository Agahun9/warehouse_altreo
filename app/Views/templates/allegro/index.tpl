      ...
      <div class="card">
        ...
        <div class="card-body border-bottom">
          <form method="get" action="{$baseUrl}" class="row g-2" id="allegroFiltersForm" data-loader-label="Ladowanie ofert Allegro...">
            ...
            <div class="col-xl-2 col-md-4">
              <label class="form-label">Nazwa w magazynie</label>
              <input type="text" name="warehouse_name" value="{$filters.warehouse_name|escape}" class="form-control" placeholder="fragment nazwy produktu">
              <div class="form-text">Szuka po nazwie produktu powiazanego w magazynie. Negacja: <code>-etui</code> albo <code>!etui</code>.</div>
            </div>
            <div class="col-xl-2 col-md-4">
          ...
          <div class="allegro-pagination-panel">
            ...
            <div class="allegro-pagination-bar">
              ...
              <form method="get" action="{$baseUrl}" class="d-flex gap-2 align-items-center">
                ...
                <input type="hidden" name="warehouse_name" value="{$filters.warehouse_name|escape}">
