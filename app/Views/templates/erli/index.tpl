      ...
      <div class="card mb-4">
          ...
          <form method="get" action="{$baseUrl}" class="row g-2" id="erliFiltersForm">
            ...
            <div class="col-xl-2 col-md-6">
              ...
              <select name="resume_ready" class="form-select">
                <option value="">Wszystkie</option>
                <option value="1"{if $filters.resume_ready|default:'' eq '1'} selected{/if}>Tylko do wznowienia</option>
              </select>
              <div class="form-text">Wylaczone w Erli, z magazynem powyzej progu "koncz ponizej" z kategorii.</div>
            </div>
            <div class="col-xl-2 col-md-6">
        ...
        <div class="card-body border-bottom">
          <form method="post" action="{$baseUrl}?controller=erli&action=queue" id="erli-bulk-form">
            ...
            <input type="hidden" name="resume_ready" value="{$filters.resume_ready|default:''|escape}">
                  ...
                  <tr class="js-erli-row {if $product.queue_meta.row_class|default:''}{$product.queue_meta.row_class|escape}{/if}">
                    ...
                    <td>
                      ...
                      {else}
                        ...
                        {if $product.buyable_problems_text|default:'' neq ''}
                          <div class="small text-secondary mt-1">{$product.buyable_problems_text|escape}</div>
                        {/if}
                      {/if}
                    </td>
