...
<section class="om-panel om-pad om-top">
  ...
  <div class="om-fiscal-help"><i class="bi bi-info-circle"></i><span>Test Posnet uruchomisz w Altreo Print Agent. Przy błędzie „No route to host” sprawdź adres IP, port Interfejsu PC (zwykle 6666) i uprawnienie agenta w macOS: Ustawienia systemowe → Prywatność i ochrona → Sieć lokalna.</span></div>
