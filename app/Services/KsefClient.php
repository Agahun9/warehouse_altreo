...
final class KsefClient
{
    ...
    private function send(string $method,string $path,array $headers,?string $body): array
    {
        ...
        curl_setopt_array($ch,[CURLOPT_RETURNTRANSFER=>true,CURLOPT_CUSTOMREQUEST=>$method,CURLOPT_HTTPHEADER=>$lines,CURLOPT_TIMEOUT=>60,CURLOPT_CONNECTTIMEOUT=>15,CURLOPT_USERAGENT=>'ALTREO-Magazyn/KSeF']);
