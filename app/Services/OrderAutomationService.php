...
final class OrderAutomationService
{
    ...
    private const PLATFORMS=['manual'=>'Własne','allegro'=>'Allegro','erli'=>'ERLI','empik'=>'Empik','mediamarkt'=>'MediaMarkt','morele'=>'Morele'];
    ...
    private function webhook(string $url,array $ctx,array $rule): int
    {
        ...
        curl_setopt_array($curl,[
            ...
            CURLOPT_HTTPHEADER=>['Content-Type: application/json','User-Agent: ALTREO-Orders-Automation/1.0','X-Altreo-Event: '.$ctx['trigger']],
        ]);
