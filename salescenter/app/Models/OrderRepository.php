...
final class OrderRepository
{
    ...
    public function ensureSchema(): void
    {
        ...
        foreach (['synced_until'=>'VARCHAR(30) NULL','next_attempt'=>'BIGINT NOT NULL DEFAULT 0','cursor_json'=>'TEXT NULL','auto_accept'=>'INTEGER NOT NULL DEFAULT 0','import_from'=>'VARCHAR(30) NULL'] as $column=>$definition) {
    ...
    public function savePaymentMapping(string $platform,string $sourceMethod,int $paymentMethodId): int
    {
        ...
        if (!in_array($platform,['allegro','erli','empik','mediamarkt','morele','altreo','temu','prestashop','woocommerce','api'],true)) { throw new InvalidArgumentException('Nieznane źródło zamówień.'); }
    ...
    public function listing(array $filters): array
    {
        ...
        // empik_offers); miniatury pochodzą z danych zamówienia. Cache ofert wróci z integracjami firm.
        $productImages=[]; $marketImages=[];
        foreach ($rows as &$row) {
